    ...
    return (<div className="page-container">
        <div className="research content-container">
            ...
            <div className="content-txt" style={{marginBottom: '10px'}}>
                ...
                sequencing, are providing a paradigm shift in genetics research. New organisms can now be adopted with
            ...
            <div className="research-txt-wrapper" id="intergenerational-inheritance">
                ...
                <div className="content-txt">
                    Information sensed by the maternal generation may be transmitted to the offspring to increase their
                    fitness. However, the mechanisms of inheritance of adaptive maternal effects through the germline
                    are largely unknown. The nematode <i>Auanema freiburgensis</i> offers many advantages for studying
                    this phenomenon, due to the easy-to-score phenotypes, short lifecycle and large reproductive output.
                    We found that environmental stress experienced by the parental generation induces the production of
                    stress-resistant offspring. Environmental signals sensed by neurons send signals to the germline to
                    change its epigenetic and transcriptional profile. The signals to the germline are mediated by
                    highly conserved energy sensors, raising the possibility that the same mechanism could be present in
            ...
            <div className="research-txt-wrapper" id="polar-body-formation-in-males">
                ...
                <div className="content-txt">
                    We discovered that <i>A. rhodensis males</i>, although being of the XO karyotype, produce only one
                    type of viable sperm: sperm with an X chromosome. The sperm without the X chromosome (the nullo-X
                    sperm) is discarded before being used. This is similar to polar bodies in females, in which 3 out of
                    ...
                    reticulum, nuclear pore proteins) are dumped into the nullo-spermatid. We are studying in how this
