...
const Publications = () => {
    ...
    const publications = [
        ...
        },
        {
            ...
            title: <div className="publication-title"><em>De novo</em> genome assembly of <em>Auanema melissensis</em>, a trioecious free-living nematode.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Parental energy-sensing pathways control intergenerational offspring sex determination in the nematode <em>Auanema freiburgensis</em>.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Newly identified nematodes from Mono Lake exhibit extreme arsenic resistance.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Chromosome-wide evolution and sex determination in the three-sexed nematode <em>Auanema rhodensis</em>.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Liposome-based transfection enhances RNAi and CRISPR-mediated mutagenesis in non-model nematode system.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Sensory neurons control heritable adaptation to stress through germline reprogramming.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Sex- and gamete-specific patterns of X chromosome segregation in a trioecious nematode.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Description of two three-gendered nematode species in the new genus <em>Auanema </em>(Rhabditina) that are models for reproductive mode evolution.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Phenotypic plasticity and developmental innovations in nematodes.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Mating dynamics in a nematode with three sexes and its evolutionary implications.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">The genome of <em>Tetranychus urticae</em> reveals herbivorous pest adaptations.</div>,
            link: "https://www.nature.com/articles/nature10640",
            journal: "Nature 479: 487-492"
        },
        {
            authors: "Chaudhuri, J., Kache, V., Pires-daSilva, A. (2011).",
            title: <div className="publication-title">Regulation of sexual plasticity in a nematode that produces males, females and hermaphrodites.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Asymmetric spermatocyte divisions as a mechanism for skewed sex ratios.</div>,
            link: "http://dx.doi.org/10.1038/ncomms1160",
            journal: "Nat Commun 2: 157."
        },
        {
            authors: "Chaudhuri, J., Parihar, M., Pires-daSilva, A. (2011).",
            title: <div className="publication-title">An introduction to worm lab: from  culturing worms to mutagenesis.</div>,
            link: "https://dx.doi.org/10.3791/2293",
            journal: "J Vis Exp 47: e2293."
        },
        {
            authors: "Meik, J.M., Lawing, M, and Pires-daSilva, A. (2010).",
            title: <div className="publication-title">Body size evolution in insular speckled rattlesnakes (Viperidae:<em> Crotalus mitchellii</em>)</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">The snake box: a novel approach for safely restraining venomous snakes.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Natural variation of outcrossing in the hermaphroditic nematode <em>Pristionchus pacificus</em>.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Deficiency in ubiquitin ligase TRIM2 causes accumulation of neurofilament light chain and neurodegeneration.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">The world of a worm: a framework for <em>Caenorhabditis</em> evolution. </div>,
            link: "http://embor.embopress.org/content/7/10/981.long",
            journal: "EMBO Rep 7, 981-984."
        },
        {
            authors: "Pires-daSilva, A. and Sommer, R. J. (2004).",
            title: <div className="publication-title">Conservation of the global sex determination gene <em>tra-1</em> in distantly related nematodes.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">A Bacterial Artificial Chromosome-based genetic linkage map of the nematode <em>Pristionchus pacificus</em>.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Formation of the egg-laying system in <em>Pristionchus pacificus</em> requires complex interactions between gonadal, mesodermal and epidermal tissues and does not rely on single cell inductions.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Microevolutionary analysis of the nematode genus <em>Pristionchus</em> suggests a recent evolution of redundant developmental mechanisms during vulva formation.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Mice deficient for spermatid perinuclear RNA-binding protein show neurologic, spermatogenic, and sperm morphological abnormalities.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title"><em>Pristionchus pacificus</em>: a satellite organism in evolutionary developmental biology.</div>,
        ...
        },
        {
            ...
            title: <div className="publication-title">Gene trap insertion into a novel gene expressed during mouse limb development.</div>,
